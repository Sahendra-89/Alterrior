...
const SERVICES = [
  {
    ...
    features: ['3D conceptual renders', 'Material & finish selection', 'Furniture procurement', 'Project management', 'Styling & staging'],
  ...
  },
  {
    ...
    features: ['Brand-aligned design', 'Space planning', 'Ergonomic workstations', 'Acoustic solutions', 'Signage integration'],
  ...
  },
  {
    ...
    features: ['Modular kitchen design', 'Custom joinery', 'Plumbing coordination', 'Appliance integration', 'Lighting design'],
  ...
  },
  {
    ...
    features: ['Site measurement & analysis', 'Floor plan optimisation', 'Furniture layout', 'Design brief document', 'Follow-up consultation'],
  ...
  },
  {
    ...
    features: ['Curated mood board', 'Local & international sourcing', 'Art selection', 'Textile & rug curation', 'Delivery coordination'],
    price: 'From ₹25,000',
    color: '#2D2418',
  },
  {
    ...
    features: ['Complete design direction', 'Contractor management', 'All rooms covered', 'Timeline guarantee', '5-year design warranty'],
    ...
    <main className="page-wrapper">
      ...
      <section className="page-hero">
        <div className="container">
          <span className="text-overline" style={{ display: 'block', marginBottom: 'var(--space-4)' }}>What We Offer</span>
          <h1 className="text-section-title">Design Services Tailored<br /><em style={{ fontStyle: 'italic', color: 'var(--color-gold)' }}>to Your Vision</em></h1>
          <p className="text-lead" style={{ maxWidth: 520, margin: 'var(--space-5) auto 0' }}>
            Every service we offer is built around one principle — your home should be the most beautiful place you know.
          </p>
        </div>
      </section>
            ...
            {SERVICES.map((svc) => (
              ...
              >
                <div className="sdc-header">
                  <div className="sdc-icon-wrap" style={{ background: svc.color + '33' }}>
                  ...
                  <span className="sdc-toggle">{activeService === svc.id ? '−' : '+'}</span>
                </div>

                <p className="sdc-desc">{svc.desc}</p>

                <div className={`sdc-features${activeService === svc.id ? ' open' : ''}`}>
                  <div className="sdc-features-inner">
                    <h6 style={{ fontSize: 'var(--text-xs)', letterSpacing: 'var(--tracking-widest)', textTransform: 'uppercase', color: 'var(--color-gold)', marginBottom: 'var(--space-3)' }}>
                      What's Included
                    </h6>
                    ...
                    <Button
                      variant="primary"
                      size="sm"
                      onClick={(e) => { e.stopPropagation(); onQuoteOpen(); }}
      ...
      <section className="section" style={{ background: 'var(--color-surface)' }}>
        <div className="container">
          <div className="section-header">
            ...
            <p>Get a ballpark figure for your project in seconds. No commitments — just clarity.</p>
          </div>
      ...
      <section className="cta-banner" style={{ paddingBlock: 'var(--space-20)' }}>
        <div className="container" style={{ textAlign: 'center' }}>
          ...
          <p style={{ color: 'var(--color-text-secondary)', margin: 'var(--space-4) auto var(--space-8)', maxWidth: 480 }}>
            Tell us about your space and we'll craft a custom proposal within 24 hours.
          </p>
          <Button variant="primary" size="lg" onClick={onQuoteOpen} id="services-cta-btn">
